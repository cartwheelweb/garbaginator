...
repo_url_help_text = settings.garbaginator_HELP_TEXT['REPO_URL']
pypi_url_help_text = settings.garbaginator_HELP_TEXT['PYPI_URL']
category_help_text = settings.garbaginator_HELP_TEXT['CATEGORY']
