...
from xanip.apps.account.openid_consumer import xanipConsumer

from homepage.views import homepage
from package.views import package_autocomplete, category, packaginate

handler500 = "xanip.views.server_error"
...
urlpatterns = patterns("",
    ...
    url(r"^admin/invite_user/$", "xanip.apps.signup_codes.views.admin_invite_user", name="admin_invite_user"),
    url(r"^admin/", include(admin.site.urls)),
    url(r"^about/", include("about.urls")),
    url(r"^account/", include("xanip.apps.account.urls")),   
    url(r"^openid/(.*)", xanipConsumer()),
    ...
    url(r"^garbaginator/$", 
                direct_to_template,
                {'template': 'package/garbaginator.html'}, 
                name="garbaginator"), 
